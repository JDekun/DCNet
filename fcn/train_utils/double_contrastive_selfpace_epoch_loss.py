...
def Hard_anchor_sampling(epoch, epochs, X, Y, y_hat, y, ignore_label: int = 255, max_views: int = 50, max_samples: int = 1024):
...
def EPOCHSELFPACEDoublePixelContrastLoss(epoch, epochs, feats, feats_y=None, labels=None, predict=None):
    ...
    feats_, feats_y_, labels_ = Hard_anchor_sampling(epoch, epochs, feats, feats_y, labels, predict)
